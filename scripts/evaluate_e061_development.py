...
from src.evaluation.calibrated_e061 import EVALUATOR_VERSION, evaluate_calibrated
...
def main() -> int:
    p = argparse.ArgumentParser(description="Score burned/development evidence with E0.6.1")
    ...
    out = {
        "schema_version": "E061_DEVELOPMENT_SCORE_V1.0.0",
