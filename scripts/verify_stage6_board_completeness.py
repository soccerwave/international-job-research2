...
def main() -> int:
    ...
    checks = {
        ...
        "production_shard_count_consistent": inventory["production_shard_count"] == board["production_shard_count"] == 19,
        "source_execution_count_consistent": inventory["source_execution_count"] == board["source_execution_count"] == 35,
