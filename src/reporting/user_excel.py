...
USER_REPORT_VERSION = "USER_REPORT_V1.4.2_E022_RECALL_SAFE"
    ...
    for record in records:
        ...
        rows.append({
            ...
            "review_reason": (
                ...
                if detail else "Excluded from JOBS by E0.2.2; retained by E1.1 for human review. Suitability is unconfirmed."
            ),
        })
    ...
    workbook.set_properties(
        {
            ...
            "comments": f"Generated by {USER_REPORT_VERSION}; JOBS uses E0.2.2; REVIEW_MORE adds E1.1 disagreements and missing-detail cases. Neither sheet guarantees suitability.",
        }
    )
