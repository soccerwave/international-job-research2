...
def main() -> int:
    p = argparse.ArgumentParser(description="Development-only score on the burned E0.3 validation set")
    ...
    if payload.get("schema_version") != "E03_VALIDATION_LABELS_V1.0.0":
        raise SystemExit("unexpected burned validation schema")
    ...
    out = {
        "schema_version": "E042_BURNED_VALIDATION_DEVELOPMENT_SCORE_V1.0.0",
        "status": "BURNED_DEVELOPMENT_EVIDENCE_NOT_PROMOTION_VALIDATION",
